...
import com.aelinstudios.sjcetalks.databinding.ItemReceiveGroupBinding;
import com.aelinstudios.sjcetalks.databinding.ItemSentGroupBinding;
                    ...
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(snapshot.exists()) {
                                ...
                                viewHolder.binding.name.setVisibility(View.VISIBLE);
                            }
                        }
